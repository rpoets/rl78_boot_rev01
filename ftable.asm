...
.jtext  .CSEG AT FLASH_TABLE                    ; Vector Name            Vector Address Relocated Vector Address
        ...
        .DB4    0xffffffff          			; INTP0                         ;0x0008 ;0x0010
         BR     !!_r_Config_INTC_intp1_interrupt; INTP1                         ;0x000A ;0x0014
        ...
        .DB4    0xffffffff      				; INTST2/INTCSI20/INTIIC20      ;0x0014 ;0x0028
        .DB4    0xffffffff    					; INTSR2                        ;0x0016 ;0x002C
        ...
        .DB4    0xffffffff                      ; INTSRE0/INTTM01H              ;0x0022 ;0x0044
         .DB4    0xffffffff      ; INTST1                        ;0x0024 ;0x0048
        .DB4    0xffffffff   ; INTCSI11/INTIIC11/INTSR1      ;0x0026 ;0x004C
        .DB4    0xffffffff     ; INTSRE1/INTTM03H              ;0x0028 ;0x0050
        .DB4    0xffffffff                      ; INTIICA0                      ;0x002A ;0x0054
         .DB4    0xffffffff    ; INTTM00                       ;0x002C ;0x0058
        ...
        .DB4    0xffffffff                      ; Reserved                      ;0x003C ;0x0078
         BR     !!_r_Config_UART1_interrupt_send   ; Reserved                      ;0x003E ;0x007C
