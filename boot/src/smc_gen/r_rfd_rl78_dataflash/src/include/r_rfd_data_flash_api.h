...
extern R_RFD_FAR_FUNC void R_RFD_BlankCheckDataFlashReq(uint32_t i_u32_start_addr, 
                                                        uint16_t i_u16_blankcheck_length);
extern R_RFD_FAR_FUNC void R_RFD_IVerifyDataFlashReq(uint32_t i_u32_start_addr, 
