/**********************************************************************************************************************
    ...
    File Name       : r_rfd_code_flash_api.h
    Program Version : V1.00
    Device(s)       : RL78/F24 microcontroller
    Description     : API definition of Code Flash Control
**********************************************************************************************************************/
...
#ifndef R_RFD_CODE_FLASH_API_H
#define R_RFD_CODE_FLASH_API_H
...
extern R_RFD_FAR_FUNC void R_RFD_WriteCodeFlashReq(uint32_t i_u32_start_addr, 
...
#endif /* end of R_RFD_CODE_FLASH_API_H */
